...
if(NOT CPPLINT_FOUND)
  ...
  set_target_properties(cpplint PROPERTIES EXCLUDE_FROM_DEFAULT_BUILD TRUE)
endif(NOT CPPLINT_FOUND)
...
function(add_cpplint _name)
  ...
  if(CPPLINT_FOUND)
    ...
    add_custom_target(${_name}_cpplint
      ...
      VERBATIM)
    set_target_properties(${_name}_cpplint PROPERTIES EXCLUDE_FROM_DEFAULT_BUILD TRUE)
